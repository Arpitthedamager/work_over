...
export default function UserList() {
  ...
  const [showTable, setShowTable] = useState(true); // New state for controlling table visibility
        ...
        <div className="user-list mt-4">
          {users.length === 0 ? (
            ...
            <ul className="space-y-4">
              {users.map((user) => (
                <li key={user._id} className="flex justify-between items-center p-4 text-white shadow-md rounded-md">
                  <div>
